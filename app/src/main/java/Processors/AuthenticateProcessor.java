...
//        sampleAppActivity.setLatestSessionResult(sessionResult);
        ...
        try {
            Log.d("testing", "authenticate faceScanBase64: "+ Arrays.toString(sessionResult.getFaceScan()));
            MainActivity.sourceImageByteArray = sessionResult.getFaceScanBase64().getBytes();
            MainActivity.targetImageByteArray = sessionResult.getFaceScanBase64().getBytes();
            Log.d("testing", "testsample"+sessionResult.getFaceScan().length);
            Log.d("testing", "testsample"+sessionResult.getFaceScan().toString());
            Log.d("testing", "testsample"+Arrays.toString(sessionResult.getFaceScan()));
